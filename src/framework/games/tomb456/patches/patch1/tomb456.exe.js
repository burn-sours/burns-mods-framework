...
module.exports = {
    variables: {
        ...
        KeyIsPressed: { Address: "0x577b40", Type: "Int8" },
        ...
        ResolutionH: { Address: "0x68c53c", Type: "Int32" },
        DevMode: { Address: "0x577C58", Type: "Int8" },
        DevModeSpeed: { Address: "0x577C68", Type: "Int32" },
        MoreSettings: { Address: "0x577C97", Type: "Int8" },
    },

    hooks: {
        KeyboardInput: { Address: "0x1900", Params: ['int'], Return: 'int' },
        TickFunction: { Address: "0x9e80", Params: ['pointer'], Return: 'void' },
        UpdateTickRef: { Address: "0x9fc0", Params: [], Return: 'void' },
    }
};
