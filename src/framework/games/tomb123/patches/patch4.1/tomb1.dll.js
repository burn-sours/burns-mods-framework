...
module.exports = {
    ...
    hooks: {
        ...
        ResetUiTexts: { Address: "0x7e3e0", Params: [], Return: 'void' },
        ...
        CalculateYawPitch: { Address: "0x68e70", Params: ['int', 'int', 'int', 'pointer'], Return: 'void' },
        TraceLineOfSight: { Address: "0x514e0", Params: ['pointer', 'pointer'], Return: 'int' },
        ...
        EntityBoulder: { Address: "0x3fd40", Params: ['int'], Return: 'void' },
        ...
        EntityCrocodileWet: { Address: "0xb430", Params: ['int'], Return: 'void' },
        EntityRatDry: { Address: "0x38080", Params: ['int', 'pointer'], Return: 'void' },
        EntityRatWet: { Address: "0x37bd0", Params: ['int', 'pointer'], Return: 'void' },
        EntityMutantSpawn: { Address: "0x492d0", Params: ['int'], Return: 'void' },
        EntityMutant: { Address: "0x46f20", Params: ['int'], Return: 'void' },
        EntityCentaurSpawn: { Address: "0x495d0", Params: ['int'], Return: 'void' },
        EntityCentaur: { Address: "0x469f0", Params: ['int'], Return: 'void' },
        EntityFallingSword: { Address: "0x41f70", Params: ['int'], Return: 'void' },
        EntityCowboy: { Address: "0x347f0", Params: ['int'], Return: 'void' },
        EntitySkaterBoy: { Address: "0x33e00", Params: ['int'], Return: 'void' },
        EntityKold: { Address: "0x34e50", Params: ['int'], Return: 'void' },
