...
## Description
Spawns a ring of 32 spark particles at a given world position, radiating outward from a specified yaw direction. Used for bullet impact visual effects. Only spawns sparks if the position is within range of Lara (±16384 units on X and Z axes).
